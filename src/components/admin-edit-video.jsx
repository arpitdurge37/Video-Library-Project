...
export function EditVideo() {
    ...
    const formik = useFormik({
        ...
        onSubmit: (video) => {
            axios.put(`https://video-library-project.onrender.com/edit-video/${video.VideoId}`, video)
                .then(() => {
    ...
    function LoadVideo() {
        axios.get(`https://video-library-project.onrender.com/get-video/${params.id}`)
            .then(response => {
